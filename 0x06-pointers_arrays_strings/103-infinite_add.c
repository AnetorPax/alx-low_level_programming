 ...
 * @n1: the string contsining the first number
 * @n2: the string containimg the second number
 * @r: the buffer that the function will use to store the result
 * @size_r: the buffer size
 * Return: if r can be stored - a pointer to the result
 * if r cannot be stored - 0
 */
